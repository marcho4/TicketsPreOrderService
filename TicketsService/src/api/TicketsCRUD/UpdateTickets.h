...
public:
    static void UpdatingTicketsRequest(const httplib::Request& req, httplib::Response& res, Database& db);

    static void UpdateTicketInDatabase(const std::string& match_id, const Ticket& ticket, Database& db);
};
