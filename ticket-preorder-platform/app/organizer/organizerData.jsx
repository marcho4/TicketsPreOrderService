...
function DataDisplay({ resource }) {
    ...
    const handleSave = async () => {
        try {
            console.log(formData);
            let resp = await fetch(`http://localhost:8000/api/organizer/update/${user}`, {
                method: "POST",
                credentials: "include",
    ...
    return (
        <div className="flex flex-col min-w-full bg-white rounded-lg p-4 gap-5">
            <div className="flex flex-row  px-5 py-5 rounded-lg justify-between">
                ...
                <Button onClick={logout} className="bg-button-secondary max-w-56 py-2 hover:bg-dark-grey">
                ...
                {!isEditing ? (
                    <div className="flex flex-col justify-center min-w-full">
                        <div className="flex flex-row items-center justify-between mt-4">
                            ...
                            <button className="bg-button-secondary text-white_smoke px-4 py-2  max-w-40  rounded-lg
                    ...
                    <div className="flex flex-col justify-center min-w-full">
                        <div className="flex flex-row items-center justify-between mt-4">
                            <div className="text-3xl font-semibold mr-2 px-4">Basic info</div>
                            <button className="bg-button-secondary px-4 py-2 text-white max-w-40  rounded-lg
                            flex flex-row items-center justify-start hover:bg-dark-grey transition-colors duration-300"
                            ...
                            <div id="labels" className="flex flex-col items-start gap-5">
                                <div className="flex flex-col w-full mt-6 space-y-4">
                                    {[
                                        ...
                                        {label: "Organization's Name", value: data.organization, name: "organization_name"},
                                        ...
                                        <div key={index}
                                            ...
                                            <input
                                                ...
                                                className="w-2/3 transition-colors text-xl rounded-lg px-4 py-2 text-center items-center
                                                 flex justify-center h-full text-my_black/80 focus:ring-2 focus:ring-blue-300 focus:outline-none">
                                            </input>
                                        </div>
                                    ))}
                                    ...
                                    <div className="flex space-x-4 px-4 justify-end">
                                        ...
                                        <button className="bg-button-secondary px-4 py-2 rounded text-white" onClick={handleSave}>
                                            Save
                                        </button>
    ...
    return (
        <div className="flex flex-col min-w-full bg-white rounded-lg p-4 gap-5">
            <div className="flex flex-row  px-5 py-5 rounded-lg justify-between">
                ...
                <Button disabled={true} className="bg-button-secondary animate-pulse max-w-56 py-2">
                    <LogOut className="mr-2"/> Logout
                </Button>
            </div>
            <div className="px-5 py-4 rounded-lg">
                ...
                <div className="flex flex-row items-center justify-between mt-4">
                        <div className="text-3xl font-semibold mr-2 px-4">Basic info</div>
                        <button disabled={true} className="bg-button-secondary text-lg px-4 py-2 text-white max-w-40  rounded-lg
...
export default function DataSection() {
    ...
    // Если юзер не авторизован не допускаю к просмотру
