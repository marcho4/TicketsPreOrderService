...
export default function Page() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-w-full gap-5 mt-5">
    ...
    return (
        data.length === 0 ? (
            <div className="flex flex-col items-center justify-center w-full min-h-[60vh]">
                <p className="text-lg text-stone-600">В данный момент нет доступных матчей</p>
            </div>
        ) : (
            <div className="p-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-7xl gap-y-10 gap-x-5 w-full items-center justify-items-center min-h-[60vh]">
                {data.map((item, index) => (
