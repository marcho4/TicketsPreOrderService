...
const createPresignedUrlWithoutClient = async ({ region, bucketName, key } : bucketName) => {
...
const createPresignedUrlWithClient = ({ region, bucketName, key } : bucketName) => {
...
const put = (url: string, data: string) => {
 ...
 */
export const main = async ({ bucketName, key, region } : bucketName) => {
    try {
